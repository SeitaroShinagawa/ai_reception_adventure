...
export const characters: Record<string, Character> = {
  professor: {
    ...
    imageUrl: (g: Gender) => `/images/characters/professor_${g}.svg`,
    spawnWeight: 3,
  },
  junior_faculty: {
    id: 'junior_faculty',
    ...
    imageUrl: (g: Gender) => `/images/characters/junior_faculty_${g}.svg`,
    spawnWeight: 4,
  },
  student: {
    id: 'student',
    ...
    imageUrl: (g: Gender) => `/images/characters/student_${g}.svg`,
    spawnWeight: 4,
  },
  engineer: {
    id: 'engineer',
    ...
    imageUrl: (g: Gender) => `/images/characters/engineer_${g}.svg`,
    spawnWeight: 3,
  },
};
